                    ...
                    <div key={index} className="flex flex-col relative">
                        ...
                        <HoverCard openDelay={200}>
                            <HoverCardTrigger asChild>
                                <span
                                    className="px-6 py-3 bg-[#1F274B] hover:bg-[#454F7B94] text-white text-sm leading-[100%] cursor-pointer uppercase"
                                >
                                    {item?.category}
                                </span>
                            </HoverCardTrigger>
                            ...
                            {/* HoverCardContent */}
                            <HoverCardContent align="end" className="w-[420px] p-0 border-0 absolute left-0  -top-[42px] rounded-none">
