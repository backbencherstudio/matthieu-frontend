  ...
  return (
    <div className="p-4 maxContainer">
      ...
      <Image
        ...
        width={800}
        height={480}
        className=" h-[200px] sm:h-[300px] md:h-[400px] w-[1600px] object-cover rounded-md mb-6"
      />
<div className='maxContainer'>
    
      <div className="flex flex-col lg:flex-row gap-8 w-full ">
        <div className="w-full lg:w-3/4">
          <h1 className="text-[#1F274B] text-[28px] sm:text-[32px] lg:text-[36px] font-extrabold leading-[124%] tracking-[0.72px] capitalize">
            2025 FEI North American Youth Championships: Arion <br className="hidden sm:block" /> Riders Bring Home Medals and Memories
          </h1>
          <p className="text-[#1D1F2C] text-[16px] sm:text-[18px] font-extrabold leading-[148%] tracking-[0.36px] mt-4">
            6 Aug, 2025
          </p>
          <p className="text-[#1D1F2C] text-[16px] sm:text-[18px] leading-normal mt-4 normal-case">
