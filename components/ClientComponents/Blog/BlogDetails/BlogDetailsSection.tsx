...
//   }
  ...
  return (
    <div className=" maxContainer">
      ...
      <div className="bg-[url('/images/blog-04.png')] bg-cover bg-center object-cover h-[400px] w-full">
  <div className='flex justify-center items-center h-full mx-auto text-center px-4 '>
    <p className=' text-white text-center text-[26px] md:text-[40px] font-extrabold leading-[124%] tracking-[0.8px] capitalize'>2025 FEI North American Youth Championships: Arion Riders Bring Home Medals and Memories</p>
  </div>
</div>
<div className=''>
...
{/* last division */}
        ...
        <div className="">
          <Image src="/blogDetails/preJunion5.png" alt="children" width={100} height={100} className="object-contain w-full h-full mt-4" unoptimized />
          <p className="text-[#777980] text-center text-[16px] mt-4 normal-case">
