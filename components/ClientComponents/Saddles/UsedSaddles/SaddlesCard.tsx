                    ...
                    >
                        ...
                        <div className="mt-5 flex flex-col gap-[12px]">
                            <div className='flex items-center justify-between '>
                                <h3 className="text-[#4C526F] font-extrabold leading-[124%] lg:text-lg  text-base  py-1">{item.name}</h3>
                                <p className="textSecondary font-extrabold leading-[136%] lg:text-2xl md:text-xl text-lg ">{item.price}</p>
                            </div>
                            <p className='textSecondary md:text-base text-sm leading-[124%] '>{item?.code}</p>
                            <p className="lg:text-xl md:text-lg font-extrabold leading-[124%] text-[#4C526F] text-base">{item.category}</p>
                            <div className='flex items-center  gap-2.5 text-[#4C526F] leading-[100%]'><SaddlesIcon/> J2</div>
                            <div className='flex items-center  gap-2.5 text-[#4C526F] leading-[100%]'><CalfIcon/> GRAINED CALF</div>
                            <div className='flex items-center  gap-2.5 text-[#4C526F] leading-[100%]'><CalenderIcon/> 2022</div>
                        </div>
                    </div>
                ))}
            </div>
