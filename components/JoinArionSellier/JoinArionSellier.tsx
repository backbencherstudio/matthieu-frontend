...
const JoinArionSellier = () => {
    return (
        <div className='maxContainer'>
            <Image src="/joinarion/horse1.png" alt='horse1' width={100} height={100} className='object-cover md:object-contain w-full min-h-[160px] border md:h-full' unoptimized></Image>
            ...
            <Image src="/joinarion/horse2.png" alt='horse'width={100} height={100} className='object-cover md:object-contain w-full min-h-[160px] border md:h-full' unoptimized></Image>

            <div className='grid grid-cols-1 md:grid-cols-2 gap-[35px] md:gap-[64px]'>
                <div className='w-6/6'>
                    <p className='normal-case text-[#4A4C56] pt-[48px]'>Join Arion Sellier as a…  <span className='text-4 text-base font-extrabold'>Saddle Fitting Expert</span></p>
                    ...
                    <div className='normal-case pl-4 text-[#4A4C56]'>
                        ...
                        <li>Colorado</li>
                        <li>More areas coming soon! If you feel that you would be a good fit and do not see your location, please inquire and let us know where you are located.</li>
                    </div>
                    ...
                    <p className='text-[#4A4C56] mt-[20px] mb-4  text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case '>What we are looking for…</p>
                    <p className='normal-case text-[#4A4C56] text-[18px] font-[400px] leading-[148%] tracking-[0.36px] pb-0 md:pb-[60px]'>Arion Sellier is looking for an independent candidate who is fascinated by the world of horses at all levels and sport. This candidate is self-motivated and hardworking. They are organized and great at communicating with their riders, professional and amateur, and other Arion team members. They are easy to talk to and knowledgeable in the sport of equestrian.</p>

                </div>
                <div className='w-6/6'>
                    <p className="text-[#4A4C56] mt-0 md:pt-[48px] pb-[16px] text-[18px] font-extrabold leading-[148%] tracking-[0.36px]">Responsibilities:</p>
                    <div className='normal-case pl-4  text-[#4A4C56]'>
                        <li>Represent and promote Arion Sellier within your territory.</li>
                        <li>Develop relationships with barn owners, trainers, and professional riders within your <br /> territory to create a strong referral network.</li>
                        <li>Provide the best customer service and after-sales care to all our customers within your territory.</li>
                        <li>Attend horse shows and events within your territory to promote brand awareness and prospect new customers.</li>
                        <li>Maintain and care for your demo saddles, accessory inventory, and company car in a responsible and organized manner.</li>
                    </div>
                    <p className="text-[#4A4C56] font-avenir text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case pb-[16px] mt-[20px]" >Ideal Candidate's Profile:</p>
                     <div className='normal-case pl-4 mb-[20px] text-[#4A4C56]'>
                        <li>Sales and/or customer service experience (ideally2 or more years).</li>
                        <li>Established relationships within the equestrian community in your territory.</li>
                    ...
                    <p className="text-[#4A4C56] font-avenir text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case mb-[16px] ">Benefits:</p>
                    <div className='normal-case pl-4 pb-[20px] text-[#4A4C56]'>
                        <li>Supportive team and leadership.</li>
                        <li>Training in horse biomechanics, saddle fitting, leather, and sales.</li>
                        <li>Base salary plus generous commission structure based upon performance.</li>
