        ...
        <div className='maxContainer'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[64px]'>
                <div className='w-6/6'>
                    ...
                    <div className='normal-case pl-4'>
                        <li>Kentucky</li>
                        <li>Texas</li>
                ...
                <div className='w-6/6'>
                    <p className="text-[#4A4C56] pt-[48px] pb-[16px] text-[18px] font-extrabold leading-[148%] tracking-[0.36px]">Responsibilities:</p>
                    <div className='normal-case pl-4 pb-[20px]'>
                    ...
                    <p className="text-[#4A4C56] font-avenir text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case pb-[16px] pt-[20px]" >Ideal Candidate's Profile:</p>
                     <div className='normal-case pl-4 pb-[20px]'>
                    ...
                    <p className="text-[#4A4C56] font-avenir text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case pb-[16px] pt-[20px]">Benefits:</p>
                    <div className='normal-case pl-4 pb-[20px]'>
