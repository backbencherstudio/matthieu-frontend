...
const JoinArionSellier = () => {
    return (
        <div className='maxContainer'>
            ...
            <p className="text-[#1F274B] text-center text-[25px] md:text-[48px] font-extrabold leading-[100%] tracking-[0.96px] pt-[30px] md:pt-[60px] pb-[30px] md:pb-[48px] normal-case">
                Join Arion Sellier
            </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-[64px]'>
                <div className='w-6/6'>
                    <p className='normal-case text-[18px] pt-[48px] text-[#1F274B]'>Join Arion Sellier as a… <strong className='text-[#4A4C56]'>Saddle Fitting Expert</strong></p>
                    ...
                    <div className='normal-case pl-4 grid gap-[12px] text-[#4A4C56]'>
                        <li>Kentucky</li>
                        <li>Texas</li>
                    ...
                    <p className='text-[#4A4C56]  text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case mt-[20px] mb-4'>What we are looking for…</p>
                    <p className='normal-case text-[#4A4C56] text-[18px] font-[400px] leading-[148%] tracking-[0.36px] mb-0 md:pb-[60px]'>Arion Sellier is looking for an independent candidate who is fascinated by the world of horses at all levels and sport. This candidate is self-motivated and hardworking. They are organized and great at communicating with their riders, professional and amateur, and other Arion team members. They are easy to talk to and knowledgeable in the sport of equestrian.</p>

                </div>
                <div className='w-6/6'>
                    <p className="text-[#4A4C56] pt-[2px] md:pt-[48px] pb-[16px] text-[18px] font-extrabold leading-[148%] tracking-[0.36px]">Responsibilities:</p>
                    <div className='normal-case pl-4 pb-[20px] grid gap-[12px]'>
                    ...
                    <p className="text-[#4A4C56] font-avenir text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case pb-[16px] " >Ideal Candidate's Profile:</p>
                     <div className='normal-case pl-4 pb-[20px] grid gap-[12px]'>
                    ...
                    <p className="text-[#4A4C56] font-avenir text-[18px] font-extrabold leading-[148%] tracking-[0.36px] normal-case pb-[16px] ">Benefits:</p>
                    <div className='normal-case pl-4 pb-[20px] grid gap-[12px]'>
